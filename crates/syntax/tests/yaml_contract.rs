...
use workflow_verifier_syntax::{Edit, ScalarStyle, TriviaKind, YamlDocument, YamlNodeKind};
...
fn scalar_style_and_raw_accessors_preserve_lexical_form_only_for_owned_text() {
    ...
    assert_eq!(
        root.field("literal")
            .and_then(workflow_verifier_syntax::YamlNode::scalar_style),
...
fn input_budget_fails_closed_without_panicking() {
    ...
    assert_eq!(problem.span.file, "ci.yml");
