...
use support::{digest, scenario};
use workflow_verifier_foundation::Budget;
use workflow_verifier_frontend::compile_auto;
use workflow_verifier_sandbox::{RunnerPlatform, plan_scenario};

fn compile(source: &str) -> workflow_verifier_domain::Graph {
